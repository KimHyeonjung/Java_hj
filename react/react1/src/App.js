import './css/App.css'; // css폴더에 App.css 가 있고, 연결할 때 사용
...
function App() {
  ...
  */
  ...
  console.log(arr1);//arr1에 4가 같이 추가(같이 추가했다기 보다 하나를 공유했기 때문에 발생한 결과)
  console.log('-------------------------------');
  ...
  orangeCount 변수에 arr5에 있는 3이 저장되도록 작성
   => 번지를 이용해서 해도 되지만, 변수 선언시 []안에 각 변수명을 써주면 해당 번지에 맞는 값들이 변수에 맵핑이 됨
  */
  var arr5 = [1, 2, 3];
  ...
  return (
    <div>
      ...
      {/* <Button text="버튼2" type="submit" className={{a:"a"}}/> */}
      <Button/>
      <br/>

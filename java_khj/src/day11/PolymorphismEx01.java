...
public class PolymorphismEx01 {
	...
	/*
	 //가전 제품 종류가 20개면 turnOn 메소드가 20개이어야 함
	 //거기에다 turnOff 메소드가 추가된다면 메소드가 총 40개여야 함.
	...
	*/
	//매개변수 다형성을 이용하면 가전제품 종류에 상관없이 하나의 메소드로 처리할 수 있음
	public static void turnOn(Appliances app) { //매개변수의 다형성
		app.power = true;

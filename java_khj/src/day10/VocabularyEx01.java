...
public class VocabularyEx01 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3 :
				...
				break;
			case 4 :
				//입력한 단어를 단어 리스트에서 삭제 deleteWord
				break;
			case 5 :
	...
	/**기능 : 입력한 단어를 단어 리스트에서 찾아 단어 정보를 삭제하는 메소드
	 * @param wordList 단어 리스트
	 * @param wordCount 현재 단어 숫자
	 */
	public static void deleteWord(Word[] wordList, int wordCount) {
		//삭제할 단어를 입력
		...
		for(int i = num; i < wordCount; i++) {
			wordList[num] = wordList[num+1];
		}
		wordCount--; //넘겨주기
		System.out.println("------------------------");
	...
	public static Word[] expandWordList(Word[] wordList, int size) {
		...
		//wordList 0번지부터 wordList.length를 tmp의 0번지부터 복붙

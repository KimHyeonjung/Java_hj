...
insert into student.student value(null, 1, 1, 4, '둘디');

-- update
# 특정 행들의 값들을 변경할 때 사용
# update 테이블명 set 속성명1 = 값1, ..., 속성명n = 값n = 값n where 조건
# = : 같다, != : 다르다, <> : 다르다, is null : null이면, ist not null : null이 아니면
# and : ~하고, or : ~이거나 
# and 와 or의 우선순위가 다름. and가 높음.
...
SET 
    name = '마이콜'
WHERE
    student.grade = 1 and student.class = 1 and student.studentNum = 2;
...
# delete는 데이터만 지우고 설정은 그대로 유지 - 대표적으로 auto_increment 시작 숫자 유지
